...
import getScheduleItemRecords from "@salesforce/apex/BT_NewGanttChartClsDemo.getScheduleItemRecords";
import getPhaseDates from "@salesforce/apex/BT_NewGanttChartClsDemo.getPhaseDates";
// import insertUpdateTask from "@salesforce/apex/BT_NewGanttChartClsDemo.insertUpdateTask";
import insertUpdateTaskList from "@salesforce/apex/BT_NewGanttChartClsDemo.insertUpdateTaskList";
import deleteTasks from "@salesforce/apex/BT_NewGanttChartClsDemo.deleteTasks";
import getTask from "@salesforce/apex/BT_NewGanttChartClsDemo.getTask";
import getEndDate from "@salesforce/apex/BT_NewGanttChartClsDemo.getEndDate";
import getAllContacts from "@salesforce/apex/BT_NewGanttChartClsDemo.getAllContacts";
import pickListValueDynamically from "@salesforce/apex/BT_NewGanttChartClsDemo.pickListValueDynamically";
import addNotesCommentToRecord from "@salesforce/apex/BT_NewGanttChartClsDemo.addNotesCommentToRecord";
// import getNotesofRecord from "@salesforce/apex/BT_NewGanttChartClsDemo.getNotesofRecord";
import getAllNotes from "@salesforce/apex/BT_NewGanttChartClsDemo.getAllNotes";
// import getattachmentLength from "@salesforce/apex/BT_NewGanttChartClsDemo.getattachmentLength";
import saveResourceForRecord from "@salesforce/apex/BT_NewGanttChartClsDemo.saveResourceForRecord";
import updateHideGanttOnSch from "@salesforce/apex/BT_NewGanttChartClsDemo.updateHideGanttOnSch";
import changeOriginalDates from "@salesforce/apex/BT_NewGanttChartClsDemo.changeOriginalDates";

import setWBSValue from "@salesforce/apex/BT_NewGanttChartClsDemo.setWBSValue";

import AdminSettings from "@salesforce/apex/BT_NewGanttChartClsDemo.getColumnSettings";
import PARSER from "@salesforce/resourceUrl/buildertek__PapaParse";

import { formatData, saveeditRecordMethod } from "./bryntum_GanttHelper_Demo";

import getRecordType from "@salesforce/apex/BT_NewGanttChartClsDemo.getRecordType";
      ...
      try {
        ...
        if (domName == "viewinc--bees" || domName == "viewinc") {
          if (
            ...
            console.log('GanttToolbarMixinDup');
            GanttToolbar = GanttToolbarMixinDup(bryntum.gantt.Toolbar);
          } else {
            console.log('GanttToolbarMixin');
        ...
        console.log('--- Error ---');
        console.error('Error createGantt ==> ', error);
